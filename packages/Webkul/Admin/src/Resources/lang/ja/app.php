    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'magic-ai' => [
                    ...
                    'settings' => [
                        ...
                        'organization'      => '組織',
                        'title'             => '一般設定',
                        'title-info'        => '独占的なAPIキーを入力し、努力せずに統合するために関連する組織を示すことで、Magic AI機能を活用してください。OpenAIの資格情報を制御し、特定のニーズに基づいて設定をカスタマイズします。',
                    ],
                    ...
                    'review-translation' => [
                        'dolphin-phi'       => 'ドルフィン Phi',
                        'enabled'           => '有効',
                        'gpt-3-5-turbo'     => 'OpenAI gpt-3.5-turbo',
                        'llama2'            => 'ラマ 2',
                        'llama2-uncensored' => 'ラマ 2 センシャーなし',
                        'llama2:13b'        => 'ラマ 2 13B',
                        'llama2:70b'        => 'ラマ 2 70B',
                        'llava'             => 'LLaVA',
                        'mistral'           => 'ミストラル',
                        ...
                        'starling-lm'       => 'スターリング',
                        'title'             => 'レビューの翻訳',
                        'title-info'        => 'お客様または訪問者に、お客様のレビューを英語に翻訳するオプションを提供します。<br/><br/>有効になっている場合、レビューに移動して、レビューが英語以外の場合は「英語に翻訳」ボタンが表示されます。',
                        'vicuna'            => 'ヴィクーニャ',
                    ],
                    ...
                    'checkout-message' => [
                        ...
                        'prompt'            => 'プロンプト',
                        'starling-lm'       => 'スターリング',
                        'title'             => 'パーソナライズド チェックアウト メッセージ',
                        'title-info'        => 'お客様へのサンクスページで個別の好みに合わせてコンテンツを調整し、全体的な購入後のエクスペリエンスを向上させるためのパーソナライズド チェックアウト メッセージを作成します。',
                        'vicuna'            => 'ヴィクーニャ',
                    ],
                ],
            ],
            ...
            'sales' => [
                ...
                'order-settings' => [
                    'info'  => '注文番号、最小注文、およびバックオーダーを設定します。',
                    'title' => '注文設定',
